...
namespace Expenses.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925155420_SplitFiscalInvoiceFromReceipt")]
    partial class SplitFiscalInvoiceFromReceipt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Expenses.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.ToTable("purchases", null, t =>
                        {
                            t.HasCheckConstraint("ck_purchases_extraction_state_with_receipt", "(receipt_state IS NOT NULL) = (receipt_storage_key IS NOT NULL OR fiscal_payload_source IS NOT NULL)");

                            t.HasCheckConstraint("ck_purchases_fiscal_all_or_nothing", "(fiscal_extracted_source IS NULL) = (fiscal_payload_source IS NULL)");

                            t.HasCheckConstraint("ck_purchases_merchant_raw_length", "merchant_raw IS NULL OR length(merchant_raw) <= 512");

                            t.HasCheckConstraint("ck_purchases_receipt_all_or_nothing", "(receipt_storage_key IS NULL) = (receipt_content_type IS NULL) AND (receipt_storage_key IS NULL) = (receipt_size_in_bytes IS NULL)");
            ...
            modelBuilder.Entity("Expenses.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.OwnsOne("Expenses.Domain.Entities.FiscalInvoice", "Fiscal", b1 =>
                        {
                            ...
                            b1.HasIndex("FiscalIkofExtracted")
                                .HasDatabaseName("ix_purchases_fiscal_ikof_extracted");

                            b1.HasIndex("FiscalIkofSupplied")
